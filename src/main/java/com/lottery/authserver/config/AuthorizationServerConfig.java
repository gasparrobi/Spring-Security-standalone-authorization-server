...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
    ...
    //    protected static final Logger LOGGER = LoggerFactory.getLogger(AuthServer.class);
    ...
    public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
        //        AuthServer.LOGGER.debug("Access, Refresh tokenek konfigurálása elkezdődött");
        clients.inMemory()
               ...
               .scopes("read")
               .secret("secret")
               .accessTokenValiditySeconds(10) // valid for 5 minutes
               .refreshTokenValiditySeconds(10); // valid for 20 minutes
        //        AuthServer.LOGGER.debug("Access, Refresh tokenek konfigurálása befejeződött");
    }
